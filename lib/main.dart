          ...
          children: <Widget>[
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, page) {
                  return Center(child: Text("$_filas"));
                },
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, page) {
                  return Center(child: Text("$_columnas"));
                },
                itemCount: _itemCount,
              ),
            ),
                    ...
                    child: Column(children: [
                      for (var j = 0; j < _columnas; j++)
                        Expanded(flex: 1, child: 
                          Container(
                            decoration:
                              BoxDecoration(color: Colors.amber, borderRadius: BorderRadius.circular(5), border: Border.all(color: Colors.black)),
